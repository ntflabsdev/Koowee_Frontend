...
/***/ 5814:
/*!*************************************************************!*\
  !*** ./src/app/step-details/step-details-routing.module.ts ***!
  \*************************************************************/
...
/* harmony export */   "StepDetailsPageRoutingModule": function() { return /* binding */ StepDetailsPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _step_details_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./step-details.page */ 94839);
...
let StepDetailsPageRoutingModule = class StepDetailsPageRoutingModule {
};
StepDetailsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/***/ 12142:
/*!*****************************************************!*\
  !*** ./src/app/step-details/step-details.module.ts ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StepDetailsPageModule": function() { return /* binding */ StepDetailsPageModule; }
/* harmony export */ });
...
/* harmony import */ var _step_details_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./step-details-routing.module */ 5814);
/* harmony import */ var _step_details_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./step-details.page */ 94839);
...
let StepDetailsPageModule = class StepDetailsPageModule {
};
StepDetailsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule,
            _step_details_routing_module__WEBPACK_IMPORTED_MODULE_0__.StepDetailsPageRoutingModule
        ],
...
/***/ 94839:
/*!***************************************************!*\
  !*** ./src/app/step-details/step-details.page.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "StepDetailsPage": function() { return /* binding */ StepDetailsPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_step_details_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./step-details.page.html */ 89632);
/* harmony import */ var _step_details_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./step-details.page.scss */ 4106);
...
/* harmony import */ var _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @capacitor/filesystem */ 61977);
/* harmony import */ var pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! pdfmake/build/pdfmake */ 40496);
...
/* harmony import */ var pdfmake_build_vfs_fonts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! pdfmake/build/vfs_fonts */ 33098);
...
pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_6__.vfs = pdfmake_build_vfs_fonts__WEBPACK_IMPORTED_MODULE_7__.pdfMake.vfs;
// import { jsPDF } from 'jspdf';

let StepDetailsPage = class StepDetailsPage {
    constructor(userService, router, alertController, activatedRoute, platform, fileOpener) {
    ...
    sendreview() {
        ...
        if (this.review != '' && this.review != undefined) {
            ...
            this.userService.postData({ review: this.review, step_id: this.trip_id, user_id: this.id }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/send_review').subscribe((result) => {
    ...
    getreviews() {
        this.userService.postData({ step_id: this.trip_id, user_id: this.id }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/get_review').subscribe((result) => {
    ...
    delete(step_id, trip_id) {
        ...
        this.userService.postData({ step_id: step_id, user_id: this.id }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/delete_step').subscribe((result) => {
            this.router.navigate(['/trip-details/' + trip_id]);
        });
    }
    deletstep(step_id, trip_id) {
    ...
    demoDownlaod() {
        dom_to_image__WEBPACK_IMPORTED_MODULE_8___default().toPng(this.element.nativeElement)
    ...
    downlaod() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
            try {
                const dataUrl = yield dom_to_image__WEBPACK_IMPORTED_MODULE_8___default().toPng(this.element.nativeElement);
                const docDefinition = {
                    content: [{
                            image: dataUrl,
                            width: 500,
                ...
                if (this.platform.is("cordova")) {
                    ...
                    this.pdfObj.getBase64((data) => (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__awaiter)(this, void 0, void 0, function* () {
                        try {
                            let path = `pdf/paymentdetail_${Date.now()}.pdf`;
                            const result = yield _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_5__.Filesystem.writeFile({
                                path,
                                data,
...
StepDetailsPage.ctorParameters = () => [
...
StepDetailsPage.propDecorators = {
    element: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_13__.ViewChild, args: ['elementId', { static: false },] }]
};
StepDetailsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
...
/***/ 4106:
/*!*****************************************************!*\
  !*** ./src/app/step-details/step-details.page.scss ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ 89632:
/*!*******************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/step-details/step-details.page.html ***!
  \*******************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
//# sourceMappingURL=src_app_step-details_step-details_module_ts-es2015.js.map