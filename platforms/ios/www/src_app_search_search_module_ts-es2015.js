...
let SearchPage = class SearchPage {
    ...
    searchuser() {
        this.userService.postData({ skip: this.page, _id: this.id, lat: this.lat, lon: this.lng }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/search_users').subscribe((result) => {
    ...
    search() {
        ...
        this.userService.postData({ skip: this.page, _id: this.id, search_by: this.country, lat: this.latitude, lon: this.longitude }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/search_users').subscribe((result) => {
