...
let ResetPasswordPage = class ResetPasswordPage {
    ...
    verify() {
        ...
        this.userService.postData({ email: this.email, otp: this.dg1 + this.dg2 + this.dg3 + this.dg4 }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/verify_otp').subscribe((result) => {
