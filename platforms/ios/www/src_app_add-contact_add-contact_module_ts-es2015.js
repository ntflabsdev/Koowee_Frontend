...
/* harmony export */   "AddContactPageRoutingModule": function() { return /* binding */ AddContactPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _add_contact_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-contact.page */ 42097);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AddContactPageModule": function() { return /* binding */ AddContactPageModule; }
/* harmony export */ });
...
/* harmony import */ var _add_contact_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-contact-routing.module */ 71794);
/* harmony import */ var _add_contact_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-contact.page */ 42097);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AddContactPage": function() { return /* binding */ AddContactPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_add_contact_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./add-contact.page.html */ 1968);
/* harmony import */ var _add_contact_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-contact.page.scss */ 29165);
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic/angular */ 76461);
...
const { Contacts } = _capacitor_core__WEBPACK_IMPORTED_MODULE_5__.Plugins;
...
let AddContactPage = class AddContactPage {
        ...
        this.userService.postData({ _id: localStorage.getItem('user_auth_id') }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/get_emergancy_contacts').subscribe((result) => {
            ...
            if (result.status == 1) {
                ...
                for (let i = 0; i < clientnames.length; i++) {
                    if (jquery__WEBPACK_IMPORTED_MODULE_4__.inArray(clientnames[i].contact_array, this.checkarray) == -1) {
    ...
    getcontacts() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            if ((0,_ionic_angular__WEBPACK_IMPORTED_MODULE_8__.isPlatform)('android')) {
                let permission = yield Contacts.getPermissions();
                ...
                for (let i = 0; i < clientname.length; i++) {
                    if (clientname[i].phoneNumbers.length > 0) {
                        for (let j = 0; j < clientname[i].phoneNumbers.length; j++) {
                            if (jquery__WEBPACK_IMPORTED_MODULE_4__.inArray(clientname[i].phoneNumbers[j].number, this.checkarray) == -1) {
                                var data = {
    ...
    addphonenumbers(contactdetail) {
        ...
        this.userService.presentLoading();
        this.userService.postData(dict, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/add_emergancy_contacts').subscribe((result) => {
            this.userService.stopLoading();
            if (result.status == 1) {
                var newArray = [];
                var clientname = this.newArrays;
                for (let i = 0; i < clientname.length; i++) {
                    if (jquery__WEBPACK_IMPORTED_MODULE_4__.inArray(clientname[i].phoneNumbers.number, this.checkarray) == -1) {
...
AddContactPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
...
//# sourceMappingURL=src_app_add-contact_add-contact_module_ts-es2015.js.map