...
let ChangePasswordPage = class ChangePasswordPage {
    ...
    login() {
        ...
        this.userService.postData(dict, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/reset_password').subscribe((result) => {
...
ChangePasswordPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
