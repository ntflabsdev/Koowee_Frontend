(function () {
  ...
  (self["webpackChunkkoowee"] = self["webpackChunkkoowee"] || []).push([["src_app_signup_signup_module_ts"], {
    ...
    /***/
    77648: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    80771: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _SignupPage = /*#__PURE__*/function () {
        function SignupPage(alertController, userService, router, sanitizer, menuCtrl, fb) {
        ...
        _createClass(SignupPage, [{
          ...
          value: function initLoginForm() {
            ...
            this.loginForm = this.fb.group({
              ...
              phone: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.pattern("^[0-9]+$")])]
            });
          }
        }, {
          ...
          value: function register() {
            ...
            if (controls["confirmpassword"].value != "" && controls["confirmpassword"].value != undefined) {
            ...
            this.userService.postData(frmdata, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/registeruser').subscribe(function (result) {
              console.log("Data  aaya ki nahi", result);

              _this.userService.stopLoading();

              if (result.status == 1) {
                _this.userService.presentToast('Your account has been registered successfully.', 'success');

                _this.router.navigate(['/']);
              } else if (result.status == 2) {
                _this.userService.presentToast('Your email has been already exists', 'danger');
              } else if (result.status == 3) {
                _this.userService.presentToast('Mobile number already exists.', 'danger');
          ...
          value: function getcountries() {
            ...
            this.userService.getData(_config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + "/get_countries").subscribe(function (result) {
              _this2.all_countries = result.data;
              console.log("COUNTRY DATA--==>", result.data);
            });
          }
        }, {
          key: "passwordshow",
          value: function passwordshow(param, cl, att) {
            if (param == "true") {
              if (att == "1") {
