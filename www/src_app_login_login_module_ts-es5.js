  ...
  (self["webpackChunkkoowee"] = self["webpackChunkkoowee"] || []).push([["src_app_login_login_module_ts"], {
    ...
    66825: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _LoginPage = /*#__PURE__*/function () {
        function LoginPage(userService, router, fb) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function login() {
            ...
            if (this.loginForm.invalid) {
              ...
              if (controls.email.status == "VALID" && controls.password.status == "VALID") {} else {
                return;
              }
            }
            ...
            this.userService.postData(dict, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/loginuser').subscribe(function (result) {
              ...
              if (result.status == 1) {
                ...
                _this.userService.presentToast('Your account has been logged in successfully.', 'success');

                var userId = _this.userService.encryptData(result.data._id, _config__WEBPACK_IMPORTED_MODULE_3__.config.ENC_SALT);
          ...
          key: "passwordshow",
          value: function passwordshow(param) {
            if (param == 'true') {
