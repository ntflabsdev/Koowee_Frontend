(function () {
  ...
  (self["webpackChunkkoowee"] = self["webpackChunkkoowee"] || []).push([["src_app_edit-profile_edit-profile_module_ts"], {
    /***/
    1871: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    71241: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      _EditProfilePageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.ReactiveFormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, _edit_profile_routing_module__WEBPACK_IMPORTED_MODULE_0__.EditProfilePageRoutingModule, ngx_geoautocomplete__WEBPACK_IMPORTED_MODULE_2__.NgxGeoautocompleteModule.forRoot()],
    ...
    /***/
    62613: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ngx_pica__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ngx-pica */
      49105);
      /* harmony import */
      ...
      var _EditProfilePage = /*#__PURE__*/function () {
        function EditProfilePage(userService, router, fb, sanitizer, _ngxPicaService) {
          ...
          this.license_error = false; // IMAGES_URL: any = config.IMAGES_URL;
        ...
        _createClass(EditProfilePage, [{
          ...
          value: function initLoginForm() {
            this.loginForm = this.fb.group({
              ...
              phone: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_6__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_6__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.Validators.pattern('^[0-9]+$')])]
            });
          ...
          value: function update() {
            ...
            var _a; // const controls:any = this.loginForm.get;
            ...
            if (((_a = this.license_file) === null || _a === void 0 ? void 0 : _a.length) > 0) {
              frmData.append("profile", ''); // console.log("mmmmmm---->", this.license_file)
            } else {
            ...
            frmData.append('email', this.loginForm.get('email').value); // frmData.append('address', this.loginForm.get('address').value); 
            ...
            console.log(""); // console.log("frmdata---->",frmData)

            this.userService.presentLoading();
            this.userService.postData(frmData, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/update_profile').subscribe(function (result) {
              // console.log("resultttttt------>", result)
              _this.userService.stopLoading();

              if (result.status == 1) {
                _this.fullname = _this.loginForm.value.firstname + ' ' + _this.loginForm.value.lastname;
                _this.fulladdress = _this.location.name;

                _this.userService.presentToast('Your profile has been updated successfully.', 'success');

                _this.router.navigate(['/edit-profile']);
              } else if (result.status == 2) {
                _this.userService.presentToast('Your email has been already exists', 'danger');
              } else if (result.status == 3) {
                _this.userService.presentToast('Your mobile number has been already exists', 'danger');
              } else if (result.status == 4) {
                _this.userService.presentToast(result.data, 'danger');
              } else {
                _this.userService.stopLoading();

                _this.userService.presentToast('Unable to send a request please try again later', 'danger');
              }
            }, function (err) {
              _this.userService.stopLoading();
          ...
          value: function changepassword() {
            ...
            var controls = this.loginForm2.controls;
            /** check form */
            ...
            this.userService.presentLoading();
            this.userService.postData(dict, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/update_password').subscribe(function (result) {
              _this2.userService.stopLoading();

              if (result.status == 1) {
                _this2.userService.presentToast('Your password has been updated successfully.', 'success');

                _this2.loginForm2.reset();
              } else {
                _this2.userService.stopLoading();

                _this2.userService.presentToast("Your old password doesn't match with our record", 'danger');
              }
            }, function (err) {
              _this2.userService.stopLoading();

              _this2.userService.presentToast('Unable to send a request please try again later', 'danger');
            });
          }
        }, {
          ...
          key: "isControlHasError2",
          value: function isControlHasError2(controlName, validationType) {
            var control = this.loginForm2.controls[controlName];
          ...
          key: "uploadLicense2",
          value: function uploadLicense2(event, type) {
            var _this3 = this;
            ...
            this._ngxPicaService.resizeImages(files, 1200, 880).subscribe(function (imageResized) {
              var reader = new FileReader();
              reader.addEventListener('load', function (event) {
                console.log('internal =', event);
                var image_file = event.target.result;
                var myArr = image_file.split(";");
                var myArr2 = myArr.split(":");
                console.log(myArr);
                console.log('detectMimeType ==', _this3.detectMimeType(image_file));
                image_file.action = type;

                if (self.allowedMimes.indexOf(image_file.type) == -1) {
                  _this3.license_error = true;
                } else {
                  _this3.license_file.push(event.target.result);

                  self.license_file = image_file;
                  console.log('image====>', _this3.license_file);
                  self.license_image_url = window.URL.createObjectURL(image_file);
                  self.is_license_uploaded = true;
                }
              }, false);
          ...
          value: function ionViewDidEnter() {
            ...
            this.getinterets();
            this.getusertypes();
            this.getcountries(); // console.log("COUNTRIES......-->",  this.loginForm.)
          }
        }, {
          key: "getinterets",
          value: function getinterets() {
            var _this4 = this;

            this.userService.postData({}, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/get_all_interest_user').subscribe(function (result) {
          ...
          value: function getusertypes() {
            ...
            this.userService.postData({}, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/get_all_usertypes').subscribe(function (result) {
              _this5.usertypes = result.data;
            });
          }
        }, {
          key: "getcountries",
          value: function getcountries() {
            ...
            this.userService.getData(_config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/get_countries').subscribe(function (result) {
              _this6.countries = result.data;
          ...
          value: function getprofile() {
            ...
            this.userService.postData({
              _id: this.id
            }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/get_user_profile').subscribe(function (result) {
              if (result.data.profile_picture != undefined) {
                _this7.proshow = false;
                _this7.proshow2 = true;
              }
              ...
              if (result.status == 1) {
                _this7.post = result.data;
                _this7.license_file = _this7.post.profile_picture;

                _this7.loginForm.patchValue({
                  firstname: _this7.post.firstname,
                  lastname: _this7.post.lastname,
                  email: _this7.post.email,
                  sdcode: _this7.post.sdcode,
                  gender: _this7.post.gender,
                  address: _this7.post.address,
                  country: _this7.post.country,
                  interests: _this7.post.interests,
                  usertype: _this7.post.usertype,
                  phone: _this7.post.phone,
                  about_me: _this7.post.about_me,
                  dob: _this7.post.dob
                });

                _this7.fulladdress = _this7.post.country;
                _this7.userSettings['inputString'] = _this7.fulladdress;
                _this7.userSettings = Object.assign({}, _this7.userSettings);
                _this7.fullname = _this7.post.firstname + ' ' + _this7.post.lastname;

                if (_this7.post.locations != undefined && _this7.post.locations.name != undefined) {
                  console.log("if condition inside --->");
                  _this7.fulladdress = _this7.post.locations.country; // console.log("iiiiiiii--->",this.post.country)

                  _this7.userSettings['inputPlaceholderText'] = _this7.fulladdress;
                  _this7.userSettings['showRecentSearch'] = false;
                  _this7.userSettings['inputString'] = _this7.fulladdress;
                  _this7.userSettings = Object.assign({}, _this7.userSettings);
                  var locate = {
                    state: _this7.post.locations.state,
                    country: _this7.post.locations.country,
                    city: _this7.post.locations.city,
                    town: _this7.post.locations.town,
                    area: _this7.post.locations.area,
                    zip_code: _this7.post.locations.zip_code,
                    lat: _this7.post.locations.lat,
                    lon: _this7.post.locations.lng,
                    location: _this7.post.locations.location,
                    place_id: _this7.post.locations.place_id,
                    reference: _this7.post.locations.reference,
                    name: _this7.post.locations.name,
                    map_url: _this7.post.locations.map_url
                  };
                  _this7.lat = _this7.post.lat;
                  _this7.lng = _this7.post.lon;
                  _this7.location = locate;
                }
              } else {
                _this7.userService.stopLoading();

                _this7.userService.presentToast('Unable to send a request please try again later', 'danger');
              }
            }, function (err) {
              _this7.userService.stopLoading();
          ...
          value: function autoCompleteCallback(data) {
            this.countryName = data.data.formatted_address; // console.log("AUTOCOMPLET --->",this.countryName)
            ...
            console.log('search data'); // console.log(data);
            ...
            if (this.errors.indexOf(location) >= 0) {
              ...
              this.lat = locate.lat;
              this.lng = locate.lng;
              this.location = locate; // console.log('full address = ', this.lat, this.lng, this.location)
            }
          }
        }, {
          ...
          value: function getAddressComponent(address_components, key) {
            ...
            if (postalCodeType != null && postalCodeType.length > 0) value = (_a = postalCodeType[0]) === null || _a === void 0 ? void 0 : _a.long_name;
            return value;
          }
        }, {
          ...
          value: function handleImageUpload(event) {
            ...
            console.log('imageFile =>>', imageFile); // console.log('originalFile instanceof Blob', imageFile instanceof Blob); // true
            ...
            (0, browser_image_compression__WEBPACK_IMPORTED_MODULE_5__["default"])(imageFile, options).then(function (compressedFile) {
              console.log("compression------>", imageFile); // console.log('compressedFile instanceof Blob', compressedFile instanceof Blob); // true
      ...
      _EditProfilePage = (0, tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
    ...
    /***/
    25494: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    9439: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
