(function () {
  ...
  (self["webpackChunkkoowee"] = self["webpackChunkkoowee"] || []).push([["src_app_trip-details_trip-details_module_ts"], {
    /***/
    57988: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "TripDetailsPageRoutingModule": function TripDetailsPageRoutingModule() {
          return (
            /* binding */
            _TripDetailsPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _trip_details_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./trip-details.page */
      14773);
      ...
      var _TripDetailsPageRoutingModule = function TripDetailsPageRoutingModule() {
        _classCallCheck(this, TripDetailsPageRoutingModule);
      };

      _TripDetailsPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    /***/
    40281: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "TripDetailsPageModule": function TripDetailsPageModule() {
          return (
            /* binding */
            _TripDetailsPageModule
          );
        }
        /* harmony export */
      ...
      var _trip_details_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./trip-details-routing.module */
      57988);
      /* harmony import */


      var _trip_details_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./trip-details.page */
      14773);
      /* harmony import */
      ...
      var _TripDetailsPageModule = function TripDetailsPageModule() {
        _classCallCheck(this, TripDetailsPageModule);
      };

      _TripDetailsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, _trip_details_routing_module__WEBPACK_IMPORTED_MODULE_0__.TripDetailsPageRoutingModule, ngx_geoautocomplete__WEBPACK_IMPORTED_MODULE_2__.NgxGeoautocompleteModule.forRoot()],
    ...
    /***/
    14773: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "TripDetailsPage": function TripDetailsPage() {
          return (
            /* binding */
            _TripDetailsPage
          );
      ...
      var _raw_loader_trip_details_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./trip-details.page.html */
      15985);
      /* harmony import */


      var _trip_details_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! pdfmake/build/pdfmake */
      40496);
      /* harmony import */


      var pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_11__);
      /* harmony import */


      var pdfmake_build_vfs_fonts__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      ...
      18752); // import { Plugins, FilesystemDirectory } from '@capacitor/core';
      ...
      var _TripDetailsPage = /*#__PURE__*/function () {
        function TripDetailsPage(userService, router, alertController, activatedRoute, geolocation, nativeGeocoder, zone, socialSharing, plt, fileOpener) {
        ...
        _createClass(TripDetailsPage, [{
          ...
          value: function getprofiledata() {
            ...
            this.userService.postData({
              _id: this.trip_auth_id
            }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/get_user_profile_detail').subscribe(function (result) {
              _this2.profile_data = result;
              console.log("profile data-->1", _this2.profile_data);
            });
          }
        }, {
          key: "add_trips_main",
          value: function add_trips_main(trip_id, index) {
          ...
          key: "add_trips_main_edit",
          value: function add_trips_main_edit(trip_id, index, url) {
            //let count:number=0;
            var count = index;
            var indexs = count + 1;
          ...
          key: "add_trips",
          value: function add_trips(trip_id, index) {
            var count = index;
            var indexs = count + 1;
            var start_date = this.trips[index].start_date;
            var start_time = this.trips[index].Start_time;
          ...
          value: function loadMap() {
            ...
            console.log("one-->"); //FIRST GET THE LOCATION FROM THE DEVICE.

            this.geolocation.getCurrentPosition().then(function (resp) {
              console.log("loadmap-->", _this3.lat, '-->', _this3.lng);
              _this3.lat = resp.coords.latitude;
              _this3.lng = resp.coords.longitude;
              var latLng = new google.maps.LatLng(_this3.lat, _this3.lng);
              var mapOptions = {
                center: {
                  lat: _this3.lat,
                  lng: _this3.lng
              ...
              _this3.map = new google.maps.Map(_this3.mapElement.nativeElement, mapOptions);
              var placesService = new google.maps.places.PlacesService(_this3.map);
          ...
          value: function displayGoogleMap() {
            ...
            var latLng = new google.maps.LatLng(this.places_data[0].trip.lat, this.places_data[0].trip.weather.location.lon);
            ...
            google.maps.event.addListenerOnce(this.map, 'idle', function () {
              ...
              _this4.mapElement.nativeElement.classList.add('show-map');
            });
          }
        }, {
          key: "getMarkers",
          ...
          value: function addMarkersToMap(museum) {
            ...
            var position = new google.maps.LatLng(museum.lat, museum.weather.location.lon);

            if (museum.images.length == 0) {
              var contentString = '<div id="content">' + '<h1 id="firstHeading" class="firstHeading">' + museum.location.name + '</h1> <div id="bodyContent"><p>' + museum.location.name + '</p><p>Link: ' + museum.location.name + ', <a href="' + museum.location.map_url + '" target="_blank">' + museum.location.map_url + '(' + museum.location.location + ').</p></div></div>';
              ...
              var _contentString = '<div id="content">' + '<h1 id="firstHeading" class="firstHeading">' + museum.location.name + '</h1> <img src="' + this.IMAGES_URL_All + '/trips/' + museum.images[0] + '"/> <div id="bodyContent"><p>' + museum.location.name + '</p><p>Link: ' + museum.location.name + ', <a href="' + museum.location.map_url + '" target="_blank">' + museum.location.map_url + '(' + museum.location.location + ').</p></div></div>';
              ...
              _museumMarker.addListener("click", function () {
                ...
                _infoWindow.open(_museumMarker.getMap(), _museumMarker);
              });
          ...
          value: function shareit(name) {
            ...
            dom_to_image__WEBPACK_IMPORTED_MODULE_10___default().toPng(div, options).then(function (dataUrl) {
              ...
              _this5.pdfObj = pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_11___default().createPdf(docDefinition);

              if (_this5.plt.is('cordova')) {
                _this5.pdfObj.getBase64(function (data) {
                  return (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__awaiter)(_this5, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                    var path, result;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.next = 4;
                            return _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_9__.Filesystem.writeFile({
                              path: path,
                              data: data,
                          ...
                          case 4:
                            ...
                            console.log('path === ', path, result.uri); //this.fileOpener.open(`${result.uri}`,'application/pdf')
                          ...
                          case 8:
                            ...
                            console.error('Unable to write file', _context.t0);
              ...
              } else {//this.pdfObj.download("payment_Details.pdf");
              }
            });
            return;
            /*************************************************************************************/
            ...
            this.userService.postData({
              name: name,
              url: 'trip-details/' + this.trip_id
            }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/create_branch_link').subscribe(function (resultsss) {
              var options = {
                Message: name,
                url: resultsss.data
              };
              ...
              _this5.socialSharing.shareWithOptions(options).then(function () {
                // Success!
          ...
          value: function shareit2(name) {
            ...
            dom_to_image__WEBPACK_IMPORTED_MODULE_10___default().toPng(div, options).then(function (dataUrl) {
              ...
              _this6.pdfObj = pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_11___default().createPdf(docDefinition);

              if (_this6.plt.is('cordova')) {
                _this6.pdfObj.getBase64(function (data) {
                  return (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__awaiter)(_this6, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                    var path, result, options;
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          ...
                          case 10:
                            ...
                            console.error('Unable to write file', _context2.t0);
          ...
          value: function shareit3(name) {
            ...
            dom_to_image__WEBPACK_IMPORTED_MODULE_10___default().toPng(div, options).then(function (dataUrl) {
              ...
              _this7.pdfObj = pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_11___default().createPdf(docDefinition);

              if (_this7.plt.is('cordova')) {
                _this7.pdfObj.getBase64(function (data) {
                  return (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__awaiter)(_this7, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
                    var path, result, contents, options;
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          ...
                          case 4:
                            ...
                            _context3.next = 8;
                            return _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_9__.Filesystem.readFile({
                              path: result.uri
                            });

                          case 8:
                            contents = _context3.sent;
                            console.log('data:', contents); //this.fileOpener.open(`${result.uri}`,'application/pdf')
          ...
          value: function shareit4(name) {
            ...
            dom_to_image__WEBPACK_IMPORTED_MODULE_10___default().toPng(div, options).then(function (dataUrl) {
              return (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__awaiter)(_this8, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
                var _this9 = this;

                var docDefinition, pdfDocGenerator;
                  ...
                  while (1) {
                    switch (_context6.prev = _context6.next) {
                      case 0:
                        ...
                        pdfDocGenerator = pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_11___default().createPdf(docDefinition);
                        pdfDocGenerator.getDataUrl(function (dataUrl) {
                          return (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__awaiter)(_this9, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
                            var _this10 = this;

                            var fileName, fileDirectory, pdfData;
                            return regeneratorRuntime.wrap(function _callee5$(_context5) {
                              while (1) {
                                switch (_context5.prev = _context5.next) {
                                  case 0:
                                    fileName = "paymentdetail_".concat(Date.now(), ".pdf");
                                    fileDirectory = _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_9__.Directory.Cache;
                                    pdfData = dataUrl.split(',')[1]; // remove the 'data:application/pdf;base64,' prefix
                                    ...
                                    return _capacitor_filesystem__WEBPACK_IMPORTED_MODULE_9__.Filesystem.writeFile({
                                      ...
                                      return (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__awaiter)(_this10, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                                        var fileUri;
                        ...
                        this.userService.stopLoading(); // this.fileOpener.open(pdfData, 'application/pdf')
          ...
          value: function shareit5(name) {
            ...
            dom_to_image__WEBPACK_IMPORTED_MODULE_10___default().toPng(div, options).then(function (dataUrl) {
              return (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__awaiter)(_this11, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
                var docDefinition, pdfDocGenerator, pdfData;
                  ...
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      case 0:
                        ...
                        pdfDocGenerator = pdfmake_build_pdfmake__WEBPACK_IMPORTED_MODULE_11___default().createPdf(docDefinition);
                        _context7.next = 4;
                        return pdfDocGenerator.getBlobUrl();

                      case 4:
                        pdfData = _context7.sent;
                        console.log("pafData", pdfData); // if (this.plt.is('cordova')) {
          ...
          key: "submits",
          value: function submits(trip_id) {
            var _this12 = this;

            this.userService.presentLoading();
            this.userService.postData({
              _id: trip_id
            }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/update_trip_status').subscribe(function (result) {
              _this12.userService.stopLoading();

              _this12.getdata();
            }, function (err) {
              _this12.userService.stopLoading();

              _this12.userService.presentToast('Failed to send request. Please try again', 'danger');
            });
          }
        }]);
      ...
      _TripDetailsPage.ctorParameters = function () {
        return [{
      ...
      _TripDetailsPage.propDecorators = {
        mapElement: [{
      ...
      _TripDetailsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_14__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_17__.Component)({
    ...
    /***/
    84432: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    15985: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=src_app_trip-details_trip-details_module_ts-es5.js.map