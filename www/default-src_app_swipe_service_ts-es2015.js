...
/* harmony export */   "SwipeService": function() { return /* binding */ SwipeService; }
/* harmony export */ });
...
let SwipeService = class SwipeService {
    constructor(alertController, http, router, userService) {
    ...
    checkSubscriptionStatus() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            const result = yield this.userService.postData({ _id: this.id }, _config__WEBPACK_IMPORTED_MODULE_2__.config.API_URL + '/get_user_profile_detail').toPromise();
            const subscription = result.data;
            const currentDate = moment__WEBPACK_IMPORTED_MODULE_0__();
            const startDate = moment__WEBPACK_IMPORTED_MODULE_0__(subscription.subcription_start_date);
            const endDate = moment__WEBPACK_IMPORTED_MODULE_0__(subscription.subcription_end_date);
    ...
    swipeRight(userId) {
        ...
        const lastSwipeTime = new Date(localStorage.getItem('lastSwipeTime'));
        if (lastSwipeTime.getTime() === currentDate.getTime() || (currentDate - lastSwipeTime) > 86400000) {
            ...
            localStorage.setItem('swipeCount', JSON.stringify(this.swipeCount));
            localStorage.setItem('lastSwipeTime', this.lastSwipeTime);
            this.userService.postData({ friendId: userId }, _config__WEBPACK_IMPORTED_MODULE_2__.config.API_URL + `/addfriend/${sender}`).subscribe((res) => {
            });
            this.router.navigate(['/connected-user/' + userId]);
        }
        else if (this.swipeCount < this.dailyLimit) {
...
SwipeService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
//# sourceMappingURL=default-src_app_swipe_service_ts-es2015.js.map