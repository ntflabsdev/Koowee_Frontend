(function () {
  ...
  (self["webpackChunkkoowee"] = self["webpackChunkkoowee"] || []).push([["src_app_notifications_notifications_module_ts"], {
    ...
    89182: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _NotificationsPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule, _notifications_routing_module__WEBPACK_IMPORTED_MODULE_0__.NotificationsPageRoutingModule],
    ...
    4598: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _NotificationsPage = /*#__PURE__*/function () {
        function NotificationsPage(userService, router, sanitizer) {
        ...
        _createClass(NotificationsPage, [{
          ...
          key: "getnotificatons",
          value: function getnotificatons() {
            var _this = this;

            this.userService.postData({
              _id: this.id
            }, _config__WEBPACK_IMPORTED_MODULE_3__.config.API_URL + '/get_notificatons').subscribe(function (result) {
              console.log(result);
      ...
      _NotificationsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
